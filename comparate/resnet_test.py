...
if os.path.isdir("comparate/saidas_rede_res/"):
    sys.exit(1)

model_final = keras.models.load_model(args.directory_models + "resnet_train.h5")
print("passou")
cont = 0
if not os.path.isdir("comparate/saidas_rede_res/"):
    print("The rec_videos directory does not exist! creating..\n")
    os.makedirs("comparate/saidas_rede_res/")
...
for drive in sorted(os.listdir(args.directory_images)):
    ...
    np.save("comparate/saidas_rede_res/short_" + str(cont) + ".npy", predicted)
    cont += 1
    files.clear()
