...
model = keras.models.load_model(args.directory + "resnet_train.h5")
...
print(
    classification_report(
        test_Y, predicted_classes, zero_division=0, target_names=target_names
    )
)

file_out1 = "../../lib/article/tabelas/resnet_test_table.tex"
file_out2 = "../../lib/article/tabelas/resnet_test_other.txt"
f1 = open(file_out1, "w")
f2 = open(file_out2, "w")
...
print(
    df.to_latex(
        ...
        index=True,
        multirow=True,
        caption="Classification Report - Resnet50",
        label="table:Tab2",
    )
)
f1.close()
