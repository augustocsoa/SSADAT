...
fig.suptitle('Graphs for '+label_1+' and '+label_0)

ax1.set_title('Comparison between Train and Valid '+label_1)
ax1.set_facecolor('#eafff5')
ax1.plot(epochs, values_1, color='r', linewidth=1.0, label="Train "+label_1)
ax1.plot(epochs, values_3, color='b', linewidth=1.0, label="Valid "+label_1)
...
ax2.set_title('Comparison between Train and Valid '+label_0)
ax2.set_facecolor('#eafff5')
ax2.plot(epochs, values_0, color='r', linewidth=1.0, label="Train "+label_0)
ax2.plot(epochs, values_2, color='b', linewidth=1.0, label="Valid "+label_0)
...
plt.savefig('alexnet_train.png', format='png', dpi=150)

plt.savefig(
  "../../lib/article/figuras/alexnet_train.pgf", format="pgf", bbox_inches="tight"
)
#plt.show()
